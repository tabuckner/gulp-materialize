...
function g(i, n) {
  ...
  var s, o = i,
    a = 0;
  if (l(i)) o = h.test(i) ? t.getElementById(i.slice(1)) : u.test(i) ? f(i) : p(i, n);
...
Object.defineProperty(y, "constructor", {
  value: _
}), _.parseHTML = f, _.noop = a, _.isFunction = r, _.isString = l, _.extend = y.extend = function(t) {
  t = t || {};
...
y.extend({
  data: function(t, e) {
    if (l(t)) return void 0 === e ? L(this[0], t) : this.each(function(i) {
      return x(i, t, e)
    });
...
y.extend({
  ...
  attr: function(t, e) {
    if (t) {
      if (l(t)) return void 0 === e ? this[0] ? this[0].getAttribute ? this[0].getAttribute(t) : this[0][t] : void 0 : this.each(function(i) {
  ...
  prop: function(t, e) {
    if (l(t)) return void 0 === e ? this[0][t] : this.each(function(i) {
      i[t] = e
    });
...
_.prefixedProp = S, _.camelCase = I, y.extend({
  css: function(t, i) {
    if (l(t)) return t = S(t), arguments.length > 1 ? this.each(function(e) {
      return e.style[t] = i
...
y.extend({
  ...
  on: function(t, e, i, n) {
    ...
    return r(e) && (i = e, e = null), "ready" === t ? (m(i), this) : (e && (s = i, i = function(t) {
...
return y.extend({
  ...
  parents: function(e) {
    ...
    return this.each(function(s) {
      for (i = s; i && i.parentNode && i !== t.body.parentNode;) i = i.parentNode, (!e || e && b(i, e)) && n.push(i)
    }), C(n)
  },
  prev: function() {
...
var s = {
  ...
  d = i.left - l,
  u = i.top - h;
return s.spaceOnRight = o ? window.innerWidth - (r.left + i.width) : e.offsetWidth - (d + i.width), (!o && d + i.width > e.offsetWidth || o && r.left + i.width > window.innerWidth) && (s.left = !1), s.spaceOnLeft = o ? r.right - i.width : d - i.width + r.width, (!o && d - i.width + r.width < 0 || o && r.right - i.width < 0) && (s.right = !1), s.spaceOnBottom = o ? window.innerHeight - (r.top + i.height + n) : a.height - (u + i.height + n), (!o && u + i.height + n > a.height || o && r.top + i.height + n > window.innerHeight) && (s.top = !1), s.spaceOnTop = o ? r.bottom - (i.height + n) : u - (i.height + n), (!o && u - i.height - n < 0 || o && r.bottom - i.height - n < 0) && (s.bottom = !1), s
...
M.anime = function() {
  ...
  function k(t, e) {
    ...
    return n(t).map(function(t, i) {
      return i = i ? 0 : e.delay, t = O.obj(t) && !O.pth(t) ? t : {
        value: t
      }, O.und(t.delay) && (t.delay = i), t
    }).map(function(t) {
      return r(t, i)
    })
  }
  function b(t, e) {
    ...
    return t.tweens.map(function(n) {
      ...
      }(n.easing), n.elasticity = (1e3 - Math.min(Math.max(n.elasticity, 1), 999)) / 1e3, n.isPath = O.pth(s), n.isColor = O.col(n.from.original), n.isColor && (n.round = 1), i = n
    })
  }
  function w(t, e, i, n) {
    var s = "delay" === t;
  ...
  function E(t) {
    ...
    return v.reset = function() {
      ...
      var t = I.indexOf(v); - 1 < t && I.splice(t, 1), v.paused = !0
    }, v.play = function() {
      v.paused && (v.paused = !1, h = 0, u = n(v.currentTime), I.push(v), S || A())
    }, v.reverse = function() {
  ...
  return E.version = "2.2.0", E.speed = 1, E.running = I, E.remove = function(t) {
    t = y(t);
  ...
  }, E.bezier = $, E.easings = D, E.timeline = function(t) {
    var e = E(t);
    return e.pause(), e.duration = 0, e.add = function(i) {
      return e.children.forEach(function(t) {
        ...
        var s = n.offset;
        n.autoplay = !1, n.direction = e.direction, n.offset = O.und(s) ? i : p(s, i), e.began = !0, e.completed = !0, e.seek(n.offset), (n = E(n)).began = !0, n.completed = !0, n.duration > i && (e.duration = n.duration), e.children.push(n)
      ...
      return _createClass(s, [{
        ...
        value: function(e) {
          ...
          if (o && -1 === [9, 13, 27, 38, 40].indexOf(e.which)) {
            ...
            r && (this.focusedIndex = t(r).index(), this._focusFocusedItem())
          }
        ...
        value: function() {
          ...
          var t = {
            ...
            e = (this.dropdownEl.offsetLeft, this.dropdownEl.offsetTop, this.dropdownEl.offsetWidth, this.dropdownEl.offsetHeight, this.el.getBoundingClientRect()),
          ...
          if (a += this.options.coverTrigger ? 0 : e.height, h.top || (h.bottom ? d = "bottom" : h.spaceOnTop > h.spaceOnBottom ? (d = "bottom", n += h.spaceOnTop, a -= h.spaceOnTop) : n += h.spaceOnBottom), !h[u]) {
  ...
  var i = {
    ...
    n = function(n) {
      ...
      function s(e, i) {
        _classCallCheck(this, s);
        var n = _possibleConstructorReturn(this, (s.__proto__ || Object.getPrototypeOf(s)).call(this, s, e, i));
        return n.el.M_Modal = n, n.options = t.extend({}, s.defaults, i), n.isOpen = !1, n.id = n.$el.attr("id"), n._openingTrigger = void 0, n.$overlay = t('<div class="modal-overlay"></div>'), s._increment++, s._count++, n.$overlay[0].style.zIndex = 1e3 + 2 * s._increment, n.el.style.zIndex = 1e3 + 2 * s._increment + 1, n._setupEventHandlers(), n
      }
      return _createClass(s, [{
        key: "destroy",
        value: function() {
    ...
    n = function(n) {
      ...
      return _createClass(s, [{
        ...
        value: function() {
          ...
          this.$el.hasClass("responsive-img") ? (i.maxWidth = this.newWidth, i.width = [this.originalWidth, i.width]) : (i.left = [i.left, 0], i.top = [i.top, 0]), e(i)
        }
      }, {
            ...
            i = {
              ...
              complete: function() {
                t.placeholder.css({
                  ...
                  top: "",
                  left: ""
                }), t.$el.removeAttr("style"), t.$el.attr("style", t.originInlineStyles), t.$el.removeClass("active"), t.doneAnimating = !0, t.ancestorsChanged.length && t.ancestorsChanged.css("overflow", ""), "function" == typeof t.options.onCloseEnd && t.options.onCloseEnd.call(t, t.el)
              }
            };
          e(i)
        }
        ...
        value: function() {
          ...
          this.$overlay.css({
            ...
            left: -1 * n.left + "px",
            top: -1 * n.top + "px"
          }), e.remove(this.el), e.remove(this.$overlay[0]), "" !== this.caption && e.remove(this.$photoCaption[0]), e({
            targets: this.$overlay[0],
            opacity: 1,
            duration: this.options.inDuration,
            easing: "easeOutQuad"
          }), "" !== this.caption && (this.$photoCaption = t('<div class="materialbox-caption"></div>'), this.$photoCaption.text(this.caption), t("body").append(this.$photoCaption), this.$photoCaption.css({
            display: "inline"
          }), e({
  ...
  var e = {
    ...
    i = function(i) {
      ...
      function n(e, i) {
        ...
        return s.el.M_Parallax = s, s.options = t.extend({}, n.defaults, i), s.$img = s.$el.find("img").first(), s._enabled = window.innerWidth > s.options.responsiveThreshold, s._updateParallax(), s._setupEventHandlers(), s._setupStyles(), n._parallaxes.push(s), s
      }
      ...
      show: function(t, e) {
        ...
        var a = function(t) {
            var e, i, n = {
              ...
              s = t && t.ownerDocument;
            return e = s.documentElement, void 0 !== t.getBoundingClientRect && (n = t.getBoundingClientRect()), i = function(t) {
        ...
        "touches" in t && (r = t.touches[0].pageY - a.top, l = t.touches[0].pageX - a.left), o.setAttribute("data-hold", Date.now()), o.setAttribute("data-scale", h), o.setAttribute("data-x", l), o.setAttribute("data-y", r);
        var d = {
          top: r + "px",
          left: l + "px"
        };
        o.className = o.className + " waves-notransition", o.setAttribute("style", n(d)), o.className = o.className.replace("waves-notransition", ""), d["-webkit-transform"] = h, d["-moz-transform"] = h, d["-ms-transform"] = h, d["-o-transform"] = h, d.transform = h, d.opacity = "1", d["-webkit-transition-duration"] = s.duration + "ms", d["-moz-transition-duration"] = s.duration + "ms", d["-o-transition-duration"] = s.duration + "ms", d["transition-duration"] = s.duration + "ms", d["-webkit-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", d["-moz-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", d["-o-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", d["transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", o.setAttribute("style", n(d))
      },
      hide: function(t) {
        o.touchup(t);
        var e = this,
  ...
  var i = {
    ...
    n = function(n) {
      ...
      return _createClass(s, [{
        ...
        key: "open",
        value: function() {
          !0 !== this.isOpen && (this.isOpen = !0, "function" == typeof this.options.onOpenStart && this.options.onOpenStart.call(this, this.el), this.isFixed && window.innerWidth > 992 ? (e.remove(this.el), e({
            targets: this.el,
            translateX: 0,
            duration: 0,
            easing: "easeOutQuad"
...
function(t) {
  M.updateTextFields = function() {
    ...
    i.html(d), "hidden" !== e.css("display") ? i.css("width", e.width() + "px") : i.css("width", t(window).width() / 2 + "px"), e.data("original-height") <= i.innerHeight() ? e.css("height", i.innerHeight() + "px") : e[0].value.length < e.data("previous-length") && e.css("height", e.data("original-height") + "px"), e.data("previous-length", e[0].value.length)
  ...
  var e = {
    ...
    i = function(i) {
      ...
      function n(e, i) {
        _classCallCheck(this, n);
        var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));
        s.el.M_Datepicker = s, s.options = t.extend({}, n.defaults, i), s.options.minDate && s.options.minDate.setHours(0, 0, 0, 0), s.options.maxDate && s.options.maxDate.setHours(0, 0, 0, 0), s.id = M.guid(), s._setupVariables(), s._insertHTMLIntoDOM(), s._setupModal(), s._setupEventHandlers(), s.options.defaultDate || (s.options.defaultDate = new Date(Date.parse(s.el.value)), s.options.setDefaultDate = !0);
      ...
      return _createClass(n, [{
        ...
        value: function(t, e, i) {
          ...
          for (var g = !1, _ = 0, y = 0; _ < f; _++) {
            ...
            E && (_ < r ? (M = v + M, x = d, L = c) : (M -= a, x = u, L = p));
            var B = {
              day: M,
              month: x,
              year: L,
            ...
            h.push(this.renderDay(B)), 7 == ++y && (l.push(this.renderRow(h, s.isRTL, g)), h = [], y = 0, g = !1)
          }
      ...
      return _createClass(n, [{
        ...
        value: function(t) {
          ...
          var e = n._Pos(t),
            i = e.x - this.x0,
            s = e.y - this.y0;
          this.moved && i === this.dx && s === this.dy && this.setHand(i, s), "hours" === this.currentView ? this.showView("minutes", this.options.duration / 2) : this.options.autoClose && (this.minutesView.addClass("timepicker-dial-out"), setTimeout(function() {
            this.done()
        ...
        value: function() {
          ...
          t('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.cancelText + "</button>").appendTo(e).on("click", this.close.bind(this)), t('<button class="btn-flat timepicker-close waves-effect" type="button" tabindex="' + (this.options.twelveHour ? "3" : "1") + '">' + this.options.doneText + "</button>").appendTo(e).on("click", this.done.bind(this)), e.appendTo(this.footer)
        }
      }, {
        key: "_clockSetup",
        value: function() {
      ...
      return _createClass(n, [{
        ...
        value: function(e) {
          ...
          var n = void 0,
            ...
            u = void 0,
            c = this.center;
          if (this.offset = "number" == typeof e ? e : this.offset, this.center = Math.floor((this.offset + this.dim / 2) / this.dim), r = -(a = (o = this.offset - this.center * this.dim) < 0 ? 1 : -1) * o * 2 / this.dim, s = this.count >> 1, this.options.fullWidth ? h = "translateX(0)" : (h = "translateX(" + (this.el.clientWidth - this.itemWidth) / 2 + "px) ", h += "translateY(" + (this.el.clientHeight - this.itemHeight) / 2 + "px)"), this.showIndicators) {
      ...
      return _createClass(n, [{
        ...
        value: function() {
          ...
          var s = this.$origin.outerWidth(),
            ...
            B = g / 2 - O / 2,
            I = {};
          I.top = v ? y + "px" : "", I.right = p ? l - k - g + "px" : "", I.bottom = f ? h - y - _ + "px" : "", I.left = c ? k + "px" : "", I.position = b, t(this.wrapper).css(I), t(this.contentEl).css({
            width: w + "px",
            height: C + "px",
            top: E + "px",
            right: "0px",
  ...
  var e = {
    ...
    i = function(i) {
      ...
      function n(e, i) {
        _classCallCheck(this, n);
        var s = _possibleConstructorReturn(this, (n.__proto__ || Object.getPrototypeOf(n)).call(this, n, e, i));
        return s.el.M_Select = s, s.options = t.extend({}, n.defaults, i), s.isMultiple = s.$el.prop("multiple"), s._keysSelected = {}, s._valueDict = {}, s._setupDropdown(), s._setupEventHandlers(), s
      }
      return _createClass(n, [{
        key: "destroy",
        value: function() {
